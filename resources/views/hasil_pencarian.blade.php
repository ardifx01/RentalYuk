...
<head>
    ...
    <title>Sewa Mobil di Surabaya - RentalYuk</title>
...
<body class="bg-gray-100 text-gray-800">
    ...
    <!-- Header (sama seperti di homepage) -->
    <header class="bg-white shadow-md sticky top-0 z-50">
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="#" class="text-2xl font-bold text-indigo-600">RentalYuk</a>
            <div class="hidden md:flex space-x-8 items-center">
                <a href="#" class="text-gray-600 hover:text-indigo-600">Sewa Mobil</a>
                <a href="#" class="text-gray-600 hover:text-indigo-600">Sewa Motor</a>
            ...
            <div class="hidden md:flex items-center space-x-4">
                 ...
                 <a href="#" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">Daftar</a>
            </div>
            ...
            <aside class="w-full lg:w-1/4">
                <div class="bg-white p-6 rounded-lg shadow-lg sticky top-28">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="range" min="100000" max="1000000" value="500000" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                             <label class="flex items-center">
                                <input type="radio" name="kapasitas" class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                    ...
                    <button class="w-full mt-6 bg-indigo-600 text-white py-2 rounded-md hover:bg-indigo-700 transition duration-300">Terapkan Filter</button>
                </div>
            </aside>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden border-2 border-yellow-400">
                        <div class="flex flex-col md:flex-row">
                            <img src="https://placehold.co/400x300/3498db/ffffff?text=Toyota+Avanza" alt="Toyota Avanza" class="w-full md:w-1/3 h-48 md:h-auto object-cover">
                            <div class="p-6 flex flex-col justify-between w-full">
                                <div>
                                    ...
                                    <p class="text-gray-700 text-sm leading-relaxed">Kondisi mobil terawat, bersih, dan siap untuk perjalanan jauh. AC dingin. Cocok untuk keluarga.</p>
                                </div>
                                <div class="flex justify-between items-center mt-4 pt-4 border-t">
                                    ...
                                    <a href="#" class="bg-indigo-600 text-white px-5 py-2 rounded-md hover:bg-indigo-700 font-semibold text-sm transition duration-300">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        <div class="flex flex-col md:flex-row">
                            <img src="https://placehold.co/400x300/e74c3c/ffffff?text=Honda+Brio" alt="Honda Brio" class="w-full md:w-1/3 h-48 md:h-auto object-cover">
                            <div class="p-6 flex flex-col justify-between w-full">
                                <div>
                                    ...
                                    <p class="text-gray-700 text-sm leading-relaxed">Mobil lincah dan irit bahan bakar, cocok untuk keliling kota. Interior bersih dan wangi.</p>
                                </div>
                                <div class="flex justify-between items-center mt-4 pt-4 border-t">
                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        <div class="flex flex-col md:flex-row">
                            <img src="https://placehold.co/400x300/2ecc71/ffffff?text=Xpander" alt="Mitsubishi Xpander" class="w-full md:w-1/3 h-48 md:h-auto object-cover">
                            <div class="p-6 flex flex-col justify-between w-full">
                                <div>
                                    ...
                                    <p class="text-gray-700 text-sm leading-relaxed">Mobil keluarga yang nyaman dengan kabin luas. Siap menemani perjalanan liburan Anda.</p>
                                </div>
                                <div class="flex justify-between items-center mt-4 pt-4 border-t">
                    ...
                    <div class="flex justify-center pt-8">
                        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                            ...
                            <a href="#" class="bg-white border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-2 py-2 rounded-r-md border">
    ...
    <!-- Footer (sama seperti di homepage) -->
