...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-md mx-auto bg-white p-8 rounded-xl shadow-lg">
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Masukkan email Anda dan kami akan mengirimkan tautan untuk mengatur ulang password Anda.</p>
        </div>
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-600">
                <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">‹ Kembali ke Login</a>
            </p>
        </div>
    </div>
